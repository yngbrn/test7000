export default function sections_text_columns_with_images() {
  const html = `
...
>
  <div class="section-content relative z-10 py-section-vertical-spacing lg:px-section lg:max-w-site lg:mx-autopx-section">
    ...
    >
      <div class="splide__track max-lg:overflow-visible pt-card-shadowpb-card-shadow">
        <ul class="splide__list section-content-top-margin lg:grid lg:gap-10grid grid-cols-1 gap-10 lg:grid-cols-12 ">
          
            <li
              class="splide__slide w-4/5 lg:w-full relative  text-scheme-text card"
            ...
            >
              <div class="card__surface p-5 text-center">
                    ...
                    <div class="relative mb-5 pt-media-shadowpb-media-shadow">
                    ...
                    <div>
                      <div class="relative mx-auto mb-5 size-[80px]">
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      "type": "select",
      "id": "crop",
      "label": "t:sections.text_columns_with_images.settings.crop.label",
      "options": [
        &#123;
          "value": "",
    ...
    &#123;
      ...
      "label": "t:sections.text_columns_with_images.settings.show_index_on_blocks.label",
      "default": false,
      "info": "t:sections.text_columns_with_images.settings.show_index_on_blocks.info"
    &#125;,
    &#123;
      "type": "select",
      "id": "index_shape",
      "label": "t:sections.text_columns_with_images.settings.index_shape.label",
      "options": [
        &#123;
          "value": "circle",
          "label": "t:common.options.circle.label",
          "group": "t:common.groups.circular"
        &#125;,
        &#123;
          "value": "star_1",
          "label": "t:common.options.star_1.label",
    ...
    &#123;
      ...
      "settings": [
        &#123;
          "type": "checkbox",
          "id": "show_image",
          "label": "t:sections.text_columns_with_images.blocks.column.settings.show_image.label",
          "default": true
        &#125;,
        &#123;
          "id": "image",
