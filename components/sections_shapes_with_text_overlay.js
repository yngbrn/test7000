export default function sections_shapes_with_text_overlay() {
  const html = `
...
<section
  ...
  data-color-scheme=""
  style="--shape-padding: rem;"
>
  <div class="section-content relative z-10 py-section-vertical-spacing lg:px-section lg:max-w-site lg:mx-autopx-section max-w-site mx-auto">
    ...
    >
      <div class="splide__track">
        <ul class="splide__list section-content-top-margin lg:grid lg:gap-10grid grid-cols-1 gap-10 lg:grid-cols-12 ">
            ...
            <li
              class="splide__slide w-full relative "
            ...
            >
              <div class="p-4 text-center">
                  ...
                  <div class="media media--css-only  media--disable-styles ">
                    <div class="media__styled-element media__shape-styled-element  flex items-center justify-center p-[var(--shape-padding)] ">
                  ...
                  <div class="media media--shape">
                    <div class="media__shape-container">
                      ...
                      <div
                        class="media__shape-wrapper flex items-center justify-center p-[var(--shape-padding)] "
...
&#123;
  "name": "t:sections.shapes_with_text_overlay.name",
  "settings": [
    &#123;
      "type": "checkbox",
    ...
    &#123;
      "type": "range",
      "id": "shape_padding",
      "label": "t:sections.shapes_with_text_overlay.settings.padding.label",
      "default": 2,
      "min": 1,
      "max": 6,
      "step": 0.1,
    ...
    &#123;
      "type": "checkbox",
      "id": "disable_shape_style",
      "label": "t:sections.shapes_with_text_overlay.settings.disable_shape_style.label",
      "default": false,
      "info": "t:sections.shapes_with_text_overlay.settings.disable_shape_style.info"
    &#125;,
    &#123;
      "type": "header",
  ...
  "blocks": [
    &#123;
      "type": "shape",
      "name": "t:common.settings.shape.label",
      "limit": 3,
      "settings": [
        &#123;
          "type": "text",
        ...
        &#123;
          "type": "select",
          "id": "shape",
          "label": "t:common.settings.shape.label",
          "default": "default",
          "options": [
            &#123;
              "value": "default",
