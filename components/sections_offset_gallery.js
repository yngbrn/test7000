export default function sections_offset_gallery() {
  const html = `

<section
  class="relative overflow-hidden bg-scheme-background text-scheme-text bg-scheme-gradient full-bleed-section"
  data-color-scheme=""
>
  <div class=" relative z-10 overflow-hidden">
    <div
      id="FeatureGallery-"
      class="grid    absolute left-1/2 top-1/2 w-full gap-theme"
    >
...
<style>
  #FeatureGallery- &#123;
    transform: translate(-50%, -50%) scale()  rotate(deg);
  &#125;
</style>


&#123;
  "name": "t:sections.offset_gallery.name",
  ...
  "settings": [
    ...
    &#123;
      "type": "paragraph",
      "content": "t:common.settings.paragraph_adjust_the_number"
    &#125;,
    &#123;
      "type": "range",
      "id": "no_mobile_grid_items",
      "min": 4,
      "max": 12,
      "step": 1,
      "label": "t:common.settings.no_mobile_grid_items.label",
      "default": 4
    &#125;,
    &#123;
      "type": "range",
      "id": "no_desktop_grid_items",
      "min": 15,
      "max": 30,
      "step": 1,
      "label": "t:common.settings.no_desktop_grid_items.label",
      "default": 24
    &#125;,
    &#123;
      "type": "range",
      ...
      "max": 1.5,
      "step": 0.1,
      "label": "t:common.settings.zoom_level.label",
      "default": 1.3
    &#125;,
    &#123;
      "type": "range",
  ...
  "blocks": [
    &#123;
      "type": "image",
      "name": "t:sections.offset_gallery.blocks.image.name",
      "settings": [
        &#123;
          "type": "image_picker",
          "id": "image",
        ...
        &#123;
          "type": "select",
          "id": "image_shape",
          "label": "t:sections.offset_gallery.blocks.image.settings.image_shape.label",
          "default": "",
          "options": [
            &#123;
              "value": "",
              "label": "t:sections.offset_gallery.blocks.image.settings.image_shape.options.same_as_section.label"
            &#125;,
            &#123;
              "value": "default",
              "label": "t:common.options.default.label",
          ...
          "info": "t:sections.offset_gallery.blocks.image.settings.image_shape.info"
        &#125;,
        &#123;
          "type": "url",
          "id": "url",
          "label": "t:sections.offset_gallery.blocks.image.settings.url.label"
        &#125;
      ]
    &#125;,
    &#123;
    ...
    &#123;
      "type": "collection",
      "name": "t:sections.offset_gallery.blocks.collection.name",
      "settings": [
        &#123;
          "type": "collection",
          "id": "collection",
    ...
    &#123;
      "type": "article",
      "name": "t:sections.offset_gallery.blocks.article.name",
      "settings": [
        &#123;
          "type": "article",
          "id": "article",
