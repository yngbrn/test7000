export default function sections_related_products() {
  const html = `
      ...
      >
        ...
        <div class="section-content px-section py-section-vertical-spacing">
          ...
          <div class="section-content-top-margin">
            <ul class="grid  gap-theme" role="list">
              
                <li aria-hidden="true" class="hidden lg:block"></li>
...
&#123;
  ...
  "settings": [
    &#123;
      "type": "paragraph",
      "content": "t:sections.related_products.settings.paragraph_dynamic_recommendations.content"
    &#125;,
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
    ...
    &#123;
      ...
      "label": "t:sections.related_products.settings.related_products_heading.label",
    ...
    &#123;
      ...
      "options": [
        &#123;
          "value": "3",
          "label": "t:sections.related_products.settings.max_products.options.3_products.label"
        &#125;,
        &#123;
          "value": "4",
          "label": "t:sections.related_products.settings.max_products.options.4_products.label"
        &#125;,
        &#123;
          "value": "6",
          "label": "t:sections.related_products.settings.max_products.options.6_products.label"
        &#125;
      ],
      "label": "t:sections.related_products.settings.max_products.label"
    &#125;,
    &#123;
      "type": "header",
