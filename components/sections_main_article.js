export default function sections_main_article() {
  const html = `
<section
  class="relative overflow-hidden bg-scheme-background text-scheme-text bg-scheme-gradient "
  data-color-scheme=""
>
  <div class="section-content px-section py-section-vertical-spacing  mx-auto">
    <div class="text-scheme-text card">
      <div class="card__surface p-5 lg:p-10">
        ...
        <h1 class="font-heading heading-feature  heading-style text-center  break-words">
          ...
          <div class="mt-10 space-y-2.5">
              ...
              <div>
                <ul class="article-tags flex flex-wrap items-center justify-center gap-4">
                    ...
                    <li class="text-sm text-scheme-text after:hidden lg:text-base">
