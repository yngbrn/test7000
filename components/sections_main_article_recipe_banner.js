export default function sections_main_article_recipe_banner() {
  const html = `
...
&#123;
  "name": "t:sections.article_recipe_banner.name",
  "settings": [
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
    ...
    &#123;
      "type": "header",
      "content": "t:common.settings.title.label"
    &#125;,
    &#123;
      "type": "select",
      "id": "text_alignment",
      "label": "t:common.settings.text_align_desktop.label",
      "options": [
        &#123;
          "value": "lg:text-left",
    ...
    &#123;
      "type": "header",
      "content": "t:common.settings.image.label"
    &#125;,
    &#123;
      "type": "select",
      "id": "crop",
  ...
  "blocks": [
    &#123;
      ...
      "name": "t:sections.article_recipe_banner.blocks.icons_with_text.name",
      "limit": 1,
      "settings": [
        &#123;
          "type": "header",
