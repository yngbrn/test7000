export default function sections_image_with_text_slideshow() {
  const html = `<section
  class="overflow-hidden bg-scheme-background text-scheme-text bg-scheme-gradient"
  data-color-scheme=""
>
  <div class="section-content py-section-vertical-spacing">
    ...
    >
      <div class="splide__track pt-media-shadowpb-media-shadow">
        <ul class="splide__list w-full" role="list">
          
          
            <li
              class="splide__slide block w-full pt-card-shadowpb-card-shadow"
...
&#123;
  "name": "t:sections.image_with_text_slideshow.name",
  "settings": [
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
    ...
    &#123;
      "type": "select",
      "id": "image_size",
      "label": "t:common.settings.image_size.label",
      "default": "half",
      "options": [
        &#123;
          "value": "third",
    ...
    &#123;
      "type": "select",
      "id": "crop",
      "label": "t:sections.image_with_text_slideshow.settings.crop.label",
      "options": [
        &#123;
          "value": "",
      ...
      "info": "t:sections.image_with_text_slideshow.settings.crop.info"
    &#125;,
    &#123;
      "type": "select",
      "id": "heading_size",
    ...
    &#123;
      "type": "header",
      "content": "t:sections.image_with_text_slideshow.settings.header_colors"
    &#125;,
    &#123;
      "type": "header",
  ...
  "blocks": [
    &#123;
      "type": "slide",
      "name": "t:sections.image_with_text_slideshow.blocks.slide.name",
      "settings": [
        &#123;
          "type": "header",
        ...
        &#123;
          "type": "select",
          "id": "image_position",
          "label": "t:common.settings.image_position_on_desktop.label",
          "default": "right",
          "options": [
            &#123;
              "value": "right",
        ...
        &#123;
          ...
          "id": "title",
          "label": "t:sections.image_with_text_slideshow.blocks.slide.settings.title.label",
          "default": "Image with text slideshow"
        &#125;,
        &#123;
          "type": "richtext",
          "id": "richtext",
