export default function sections_scrolling_logos() {
  const html = `
...
&#123;
  "name": "t:sections.scrolling_logos.name",
  "settings": [
    &#123;
    ...
    &#123;
      ...
      "max": 400,
      "step": 10,
      "label": "t:sections.scrolling_logos.blocks.speed.name",
      "default": 180
    &#125;,
    &#123;
      "type": "select",
      "id": "direction",
      "label": "t:sections.scrolling_logos.blocks.direction.name",
      "options": [
        &#123;
          "value": "normal",
          "label": "t:sections.scrolling_logos.blocks.direction.options.normal.label"
        &#125;,
        &#123;
          "value": "reverse",
          "label": "t:sections.scrolling_logos.blocks.direction.options.reverse.label"
        &#125;
      ],
      "default": "normal"
    &#125;,
