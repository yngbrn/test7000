export default function sections_collection_list_carousel() {
  const html = `
    ...
    >
      <div class="splide__track">
        <ul class="splide__list  w-full mt-10">
            ...
            <li
              class="splide__slide gallery-item  pt-media-shadowpb-media-shadow"
            >
              ...
              <li
                class="splide__slide gallery-item w-4/5 pt-card-shadowpb-card-shadow"
              >
                <div class="relative flex items-center justify-center">
                  <a href="" class="group block w-full">
...
&#123;
  "name": "t:sections.collection_slideshow.name",
  "settings": [
    &#123;
      "id": "title",
    ...
    &#123;
      ...
      "id": "collection_list",
      "label": "t:common.settings.collections.label"
    &#125;,
    &#123;
      "type": "select",
      "id": "crop",
