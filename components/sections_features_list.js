export default function sections_features_list() {
  const html = `
  ...
  <li class="features-list__item flex items-center justify-between gap-x-3 " >
    <span></span>
    <div class="inline-block h-5 w-5 shrink-0 rounded-full rounded-full border-[calc(var(--icon-thickness)_*_1px)] border-current">
...
<section
  class="features-list bg-scheme-background text-scheme-text bg-scheme-gradient relative overflow-hidden"
  data-color-scheme=""
>
  <div class="section-content relative z-10 px-section py-section-vertical-spacing">
    <div class="relative z-10 mx-auto">
      
        <h2 class="inline-heading-rte font-heading  heading-style break-words text-center  mx-auto">
      ...
      <div class="section-content-top-margin mx-auto ">
        <div class="card mx-auto">
          ...
          >
            <ul
              class="features-list__container text-left lg:hidden features-list--border-all-rowsfeatures-list--border-top-bottomfeatures-list--border-between-rows"
            >
              ...
              <div
                class="features-list__container features-list--two-col hidden text-left lg:grid lg:grid-cols-2 lg:gap-x-8 features-list--border-all-rowsfeatures-list--border-top-bottomfeatures-list--border-between-rows"
              >
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      "type": "header",
      "content": "t:sections.features_list.settings.features_table.label"
    &#125;,
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
    ...
    &#123;
      ...
      "label": "t:sections.features_list.settings.two_columns_desktop.label",
      "default": true
    &#125;,
    &#123;
      "type": "select",
      "id": "max_width_table",
      "label": "t:sections.features_list.settings.max_width_table.label",
      "options": [
        &#123;
          "value": "",
  ...
  "blocks": [
    &#123;
      "type": "list_item",
      "name": "t:sections.features_list.blocks.feature.label",
      "settings": [
        &#123;
          "type": "text",
          "id": "title",
