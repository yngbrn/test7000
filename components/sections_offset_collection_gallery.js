export default function sections_offset_collection_gallery() {
  const html = `
...
<section
  ...
  data-color-scheme=""
>
  <div class="offset-gallery-container  relative z-10 overflow-hidden">
    <div
      id="FeatureGallery-"
    ...
    >
          ...
          >
            <a
              :tabindex="tabIndex"
              class="group block  transform transition duration-200 ease-in-out hover:scale-105"
            >
              <div class="relative w-full">
...
&#123;
  "name": "t:sections.offset_collection_gallery.name",
