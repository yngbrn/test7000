export default function sections_hero_slideshow() {
  const html = `
...
>
  <div
      ...
      id="slideshow-"
      class="section-content splide py-section-vertical-spacing"
      data-splide='&#123;"autoplay":, "interval":  &#125;'
  ...
  >
    <div class="splide__track">
      ...
      <div class="splide__arrows mt-5 flex items-center justify-between px-section relative lg:absolute z-30 bottom-0 right-0 pb-5">
...
&#123;
  "name": "t:sections.hero_slideshow.name",
  "settings": [
    &#123;
      "type": "select",
      "id": "style",
      "label": "t:sections.hero_slideshow.settings.style.label",
      "default": "full",
      "options": [
        &#123;
          "value": "inset",
    ...
    &#123;
      "type": "select",
      "id": "height",
      "label": "t:sections.hero_slideshow.settings.height.label",
      "options": [
        &#123;
          "value": "natural",
          "label": "t:sections.hero_slideshow.settings.height.options.adapt_to_first_slide.label"
        &#125;,
        &#123;
    ...
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
      "label": "t:sections.hero_slideshow.settings.display_on_card.label",
      "default": true
    &#125;,
    &#123;
      "type": "checkbox",
    ...
    &#123;
      "type": "checkbox",
      "id": "auto_rotate",
      "label": "t:sections.hero_slideshow.settings.auto_rotate.label",
      "info": "t:sections.hero_slideshow.settings.auto_rotate.info"
    &#125;,
    &#123;
      "type": "select",
      "id": "slide_speed",
      "label": "t:sections.hero_slideshow.settings.slide_speed.label",
      "options": [
        &#123;
          "value": "5000",
          "label": "t:sections.hero_slideshow.settings.slide_speed.options.5_seconds.label"
        &#125;,
        &#123;
          "value": "6000",
          "label": "t:sections.hero_slideshow.settings.slide_speed.options.6_seconds.label"
        &#125;,
        &#123;
          "value": "7000",
          "label": "t:sections.hero_slideshow.settings.slide_speed.options.7_seconds.label"
        &#125;,
        &#123;
          "value": "8000",
          "label": "t:sections.hero_slideshow.settings.slide_speed.options.8_seconds.label"
        &#125;,
        &#123;
          "value": "9000",
          "label": "t:sections.hero_slideshow.settings.slide_speed.options.9_seconds.label"
        &#125;,
        &#123;
          "value": "10000",
          "label": "t:sections.hero_slideshow.settings.slide_speed.options.10_seconds.label"
        &#125;
      ]
    &#125;,
    &#123;
      "type": "header",
      "content": "t:sections.hero_slideshow.settings.header_text_overlay_defaults",
      "info": "These settings apply to all slides by default but they can be changed on each individual slide"
    &#125;,
    &#123;
      "type": "select",
      "id": "place_content",
      "label": "t:sections.hero_slideshow.settings.place_content.label",
      "options": [
        &#123;
    ...
    &#123;
      "type": "select",
      "id": "text_align",
      "label": "t:sections.hero_slideshow.settings.text_align.label",
      "options": [
        &#123;
          "value": "text-left",
  ...
  "blocks": [
    &#123;
      "type": "slide",
      "name": "t:sections.hero_slideshow.blocks.slide__image.name",
      "settings": [
        &#123;
          "type": "image_picker",
          "id": "image",
        ...
        &#123;
          "type": "header",
          "content": "t:common.settings.header_call_to_action"
        &#125;,
        &#123;
          "type": "url",
          "id": "cta_url",
        ...
        &#123;
          "type": "header",
          "content": "t:common.settings.header_text_overlay"
        &#125;,
        &#123;
          "type": "select",
          "id": "place_content",
          ...
          "options": [
            &#123;
              "value": "inherit",
              "label": "t:common.options.follow_section.label"
            &#125;,
            &#123;
              "value": "place-content-start-start",
              "label": "t:common.options.top_left.label"
    ...
    &#123;
      "type": "video_slide",
      "name": "t:sections.hero_slideshow.blocks.slide__video.name",
      "settings": [
        &#123;
          "id": "video",
          "type": "video",
        ...
        &#123;
          "type": "select",
          "id": "crop_desktop",
          "label": "t:sections.hero_slideshow.blocks.slide__video.settings.crop_desktop.label",
          "info": "t:sections.hero_slideshow.blocks.slide__video.settings.crop_desktop.info",
          "options": [
            &#123;
              "value": "natural",
              "label": "t:common.options.natural.label"
