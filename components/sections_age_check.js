export default function sections_age_check() {
  const html = `
  <data-island
    x-data="
      AgeCheck(&#123;
          ...
          >
            ...
            >
              <div class="card__surface p-5 lg:p-10 section-content relative z-10 mx-auto space-y-5 text-center">
                  ...
                  <h2
                    class="inline-heading-rte font-heading heading-standard heading-style "
                  >
                  ...
                  <div class="inline-rte mx-auto font-main leading-snug">
                    ...
                    <div class="input-container w-full">
                      <label class="visually-hidden" for="age-check-day"></label>
                      <input
                        type="tel"
                        maxlength="2"
                        id="age-check-day"
                    ...
                    <div class="input-container w-full">
                      <label class="visually-hidden" for="month" id="age-check-month"></label>
                      <input
                        type="tel"
                        maxlength="2"
                        id="age-check-month"
                    ...
                    >
                      ...
                      <div class="input-grid-item col-span-4">
                        <div class="input-container">
                          <label class="visually-hidden" for="age-check-year">
