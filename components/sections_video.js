export default function sections_video() {
  const html = `

<section
  class="relative grid bg-scheme-background text-scheme-text bg-scheme-gradient overflow-hidden"
  data-color-scheme=""
>
  <div class="section-content py-section-vertical-spacing">
    
      <h2 class="inline-heading-rte font-heading heading-standard heading-style break-words text-center  pt-section-vertical-spacing">
    ...
    <div class="mx-auto w-full max-w-site px-section  section-content-top-margin">
      <div class="section-content relative z-10 mx-auto w-full text-center">
            ...
            >
              <div
                class="media media--css-only absoluteabsolute pointer-events-none inset-0 h-full w-full"
              >
            ...
            >
              <div
                class="media media--css-only absoluteabsolute inset-0 h-full w-full"
              >
          ...
          >
            <div
              class="media media--css-only absolute top-0 left-0 right-0 bottom-0 w-full h-full"
  ...
  "settings": [
    ...
    &#123;
      ...
      "options": [
        ...
        &#123;
          "value": "4:3",
          "label": "t:sections.video.settings.aspect_ratio.options.standard_4_3.label"
        &#125;,
        &#123;
          "value": "16:9",
          "label": "t:sections.video.settings.aspect_ratio.options.widescreen_16_9.label"
        &#125;,
        &#123;
          "value": "2.35:1",
          "label": "t:sections.video.settings.aspect_ratio.options.extra-wide_235_1.label"
        &#125;
      ]
    &#125;,
    &#123;
    ...
    &#123;
      ...
      "options": [
        &#123;
          "value": "preview",
          "label": "t:sections.video.settings.mode.options.preview.label"
        &#125;,
        &#123;
          "value": "autoplay",
          "label": "t:sections.video.settings.mode.options.autoplay.label"
        &#125;
      ],
      "default": "preview",
      "info": "t:sections.video.settings.mode.info"
    &#125;,
    &#123;
      "type": "select",
      "id": "playback",
      "label": "t:sections.video.settings.playback.label",
      "options": [
        &#123;
          "value": "inline",
          "label": "t:sections.video.settings.playback.options.inline.label"
        &#125;,
        &#123;
          "value": "modal",
          "label": "t:sections.video.settings.playback.options.modal.label"
        &#125;
      ],
      "default": "inline",
      "info": "t:sections.video.settings.playback.info"
    &#125;,
    &#123;
      "type": "header",
