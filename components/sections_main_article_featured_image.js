export default function sections_main_article_featured_image() {
  const html = `
...
&#123;
  "name": "t:sections.article_featured_image.name",
  "settings": [
    &#123;
      "type": "select",
      "id": "style",
      "label": "t:sections.article_featured_image.settings.style.label",
      "default": "full",
      "options": [
        &#123;
          "value": "full",
    ...
    &#123;
      "type": "select",
      "id": "height",
      "label": "t:sections.article_featured_image.settings.height.label",
      "options": [
        &#123;
          "value": "natural",
      ...
      "default": "pt-two-thirds-screen-height"
    &#125;,
    &#123;
      "type": "header",
