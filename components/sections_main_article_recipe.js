export default function sections_main_article_recipe() {
  const html = `

<section
  class="recipe relative overflow-hidden bg-scheme-background text-scheme-text bg-scheme-gradient mx-auto"
  data-color-scheme=""
>
  <div class="section-content mx-auto w-full  px-section">
    <div class="recipe__container flex flex-wrap gap-theme">
        ...
        <div class="recipe__ingredients-container z-10 flex grow flex-col gap-theme">
                  ...
                  <div
                    class="pt-card-shadowpb-card-shadow"
                    
                  >
                    

                    <div
                      class="recipe__ingredients text-scheme-text cardw-4/5 w-full self-center"
                      
                    >
                      <div class="card__surface relative z-10 p-5">
      ...
      <div class="recipe__main grow-[999] basis-0mx-auto max-w-3xl [min-inline-size:50%]">
        <div class="text-scheme-text card">
          <div class="p-5 lg:px-10 card__surface">
            ...
            <data-island class="rte mt-5" x-data="RTE">
              ...
              <div class="mt-10">
                <h3 class="font-heading heading-standard  heading-style break-words text-center ">
                      ...
                      <div class="mt-5 lg:grid lg:grid-cols-2 lg:gap-10">
                        ...
                        >
                          ...
                          <textarea
                            ...
                            rows="4"
                            required
                            class=" lg:flex-1  input-error"
                          >
                          
                        </textarea>
                        </div>

                        <div class="lg:col-span-2 lg:flex lg:justify-betweenlg:justify-end mt-5 text-right lg:mt-0">
