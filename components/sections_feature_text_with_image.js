export default function sections_feature_text_with_image() {
  const html = `
<section
...
&#123;
  "name": "t:sections.feature_text_with_image.name",
  "settings": [
    &#123;
      "type": "inline_richtext",
      "id": "title",
      "label": "t:common.settings.title.label",
      "default": "Feature text with image"
    &#125;,
    &#123;
      "type": "range",
    ...
    &#123;
      ...
      "label": "t:sections.feature_text_with_image.settings.max_width_heading.label",
      "options": [
        &#123;
          "value": "",
    ...
    &#123;
      "type": "header",
      "content": "t:sections.feature_text_with_image.settings.image_layout_mobile.label"
    &#125;,
    &#123;
      "type": "range",
      "id": "max_width_image_mobile",
      "min": 50,
      "max": 100,
      "step": 10,
      "unit": "%",
      "label": "t:sections.feature_text_with_image.settings.max_width_image.label",
      "default": 100
    &#125;,
    &#123;
      "type": "range",
      "id": "image_offset_mobile",
      "label": "t:sections.feature_text_with_image.settings.image_offset.label",
      "min": 0,
      "max": 8,
      "step": 0.5,
      "unit": "rem",
    ...
    &#123;
      "type": "header",
      "content": "t:sections.feature_text_with_image.settings.image_layout_desktop.label"
    &#125;,
    &#123;
      "type": "range",
      "id": "max_width_image_desktop",
      "min": 50,
      "max": 100,
      "step": 10,
      "unit": "%",
