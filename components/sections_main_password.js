export default function sections_main_password() {
  const html = `

<section
  class="relative overflow-hidden text-scheme-text"
  data-color-scheme=""
>
  <div class="section-content max-w-mdmax-w-sm mx-auto flex w-full items-center justify-center text-center pt-card-shadowpb-card-shadow">
    <div class="card">
      <div class="space-y-5  card__surface p-5 lg:p-10">
        <h1 class="font-heading heading-feature w-full text-center text-2xl">
            ...
            <span class="mx-auto  block max-w-[12rem] break-words sm:max-w-md lg:max-w-2xl xl:max-w-none">
          ...
          <h2 class="inline-heading-rte font-heading heading-standard">
          ...
          <div class="mt-5">
              ...
              <div class="inline-rte text-base">
                
              </div>
            
          </div>

          <div class="mt-5 pt-button-shadowpb-button-shadow">
              ...
              <div class="items-center justify-center lg:flex">
                ...
                <label for="NewsletterForm-" class="sr-only">
                ...
                <div class=" w-full flex-grow lg:mr-2">
                  <input
                    ...
                    type="email"
                    name="contact[email]"
                    class="input input-group-field w-full text-scheme-text placeholder:text-scheme-text border-scheme-errorborder-scheme-text"
                    value=""
                    autocorrect="off"
                    autocapitalize="off"
                    autocomplete="email"
...
<div
  class="fixed bottom-0 left-0 right-0 top-0 z-[-1] bg-scheme-background bg-scheme-gradient"
  data-color-scheme=""
></div>
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      ...
      "id": "title",
      "label": "t:sections.password.settings.title.label",
    ...
    &#123;
      "type": "header",
      "content": "t:sections.password.settings.header_newsletter"
    &#125;,
    &#123;
      "type": "checkbox",
    ...
    &#123;
      ...
      "label": "t:sections.password.settings.newsletter_form_heading.label",
      "default": "Be the first to know when we launch.",
      "info": "t:sections.password.settings.newsletter_form_heading.info"
    &#125;,
    &#123;
      "type": "header",
