export default function sections_rich_text() {
  const html = `<section
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      "id": "rich_text",
      "type": "richtext",
      "label": "t:sections.rich_text.settings.rich_text.label",
    &#125;,
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
    ...
    &#123;
      ...
      "label": "t:sections.rich_text.settings.content_width_desktop.label",
      "default": "lg:w-2/3",
      "options": [
        &#123;
          "value": "lg:w-1/3",
