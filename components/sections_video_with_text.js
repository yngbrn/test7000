export default function sections_video_with_text() {
  const html = `
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      "type": "select",
      "id": "video_shape",
      "label": "t:common.settings.video_shape.label",
      "options": [
        &#123;
          "value": "default",
      ...
      "info": "t:common.settings.video_shape.info"
    &#125;,
    &#123;
      "type": "range",
      "id": "blob_type",
    ...
    &#123;
      ...
      "step": 2,
      "unit": "deg",
      "label": "t:common.settings.rotate_video.label",
      "default": 0
    &#125;,
    &#123;
      "type": "select",
      "id": "video_position",
      "label": "t:common.settings.video_position.label",
      "default": "right",
      "options": [
        &#123;
          "value": "right",
    ...
    &#123;
      "type": "select",
      "id": "video_size",
      "label": "t:common.settings.video_size.label",
      "default": "half",
      "options": [
        &#123;
          "value": "third",
    ...
    &#123;
      ...
      "id": "title",
      "label": "t:sections.video_with_text.settings.title.label",
      "default": "Video with text"
    &#125;,
    &#123;
      "type": "select",
      "id": "heading_size",
      "label": "t:sections.video_with_text.settings.heading_size.label",
      "options": [
        &#123;
