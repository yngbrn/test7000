export default function snippets_media_image_placeholder() {
  const html = `


  <div
    id="media-"
    class="media media--css-only media--disable-styles  object-wrapper "
  >
    
  </div>

  <div id="media-" class="media media--shape">
