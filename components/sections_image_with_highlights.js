export default function sections_image_with_highlights() {
  const html = `
...
<section
  ...
  data-color-scheme=""
  style="--image-max-width: px;"
>
  <div class="section-content relative z-10 py-section-vertical-spacing lg:px-section lg:max-w-site lg:mx-autopx-section">
    ...
    <div class="hidden grid-cols-4 gap-theme lg:grid  section-content-top-margin">
      <!-- Left Column -->
      <div class="col-span-1 flex flex-col  gap-theme">
        
      </div>

      <!-- Middle Column -->
      <div class="col-span-2 flex items-center justify-center">
        <div class="w-full pt-media-shadowpb-media-shadow max-w-[var(--image-max-width)]">
    ...
    <div class="lg:hidden">
      <div class="max-w-site px-section lg:hidden section-content-top-margin pt-media-shadowpb-media-shadow">
      ...
      >
        <div class="splide__track pt-card-shadowpb-card-shadow">
          <ul class="splide__list section-content-top-margin lg:grid lg:gap-10grid grid-cols-1 gap-10 lg:grid-cols-12 ">
            
          </ul>
        </div>
        
          <div class="splide__arrows mt-5 flex items-center justify-between px-section lg:hidden">
...
&#123;
  "name": "t:sections.image_with_highlights.name",
  "settings": [
    &#123;
    ...
    &#123;
      "type": "select",
      "id": "block_alignment_on_desktop",
      "label": "t:sections.image_with_highlights.settings.block_alignment_on_desktop.label",
    ...
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
      "label": "t:common.settings.display_blocks_on_cards.label",
      "default": true
    &#125;,
    &#123;
      "type": "checkbox",
      "id": "slideshow_on_mobile",
      "label": "t:sections.text_columns_with_images.settings.slideshow_on_mobile.label",
      "default": true
    &#125;,
    &#123;
      "type": "select",
      "id": "slideshow_focus",
      "label": "t:common.settings.slideshow_focus.label",
      "options": [
        &#123;
          "value": "center",
          "label": "t:common.options.center.label"
    ...
    &#123;
      "type": "header",
      "content": "t:common.settings.header_image"
    &#125;,
    &#123;
      "type": "image_picker",
      "id": "image",
    ...
    &#123;
      "type": "range",
      "id": "max_width",
      "label": "t:sections.image_with_highlights.settings.max_width.label",
      "default": 500,
      "min": 250,
      "max": 1000,
      "step": 10,
    ...
    &#123;
      ...
      "max": 20,
      "step": 1,
      "label": "t:common.settings.blob_type.label",
      "default": 1,
      "info": "t:common.settings.blob_type.info"
    &#125;,
    &#123;
      "type": "range",
      "id": "rotate_image",
    ...
    &#123;
      ...
      "label": "t:common.settings.disable_media_style.label",
      "default": false,
      "info": "t:common.settings.disable_media_style.info"
    &#125;,
    &#123;
      "type": "header",
  ...
  "blocks": [
    &#123;
      "type": "highlight",
      "name": "t:sections.image_with_highlights.blocks.highlight.name",
      "limit": 6,
      "settings": [
        &#123;
          "type": "text",
        ...
        &#123;
          "type": "inline_richtext",
          "id": "text",
          "label": "t:sections.text_columns_with_images.blocks.column.settings.text.label",
        &#125;,
        &#123;
          "type": "header",
        ...
        &#123;
          "type": "url",
          "id": "cta_link",
          "label": "t:sections.text_columns_with_images.blocks.column.settings.cta_link.label"
        &#125;,
        &#123;
          "type": "text",
          "id": "cta_text",
          "label": "t:sections.text_columns_with_images.blocks.column.settings.cta_text.label"
        &#125;,
        &#123;
          "type": "header",
          "content": "t:common.settings.header_color"
        ...
        &#123;
          "type": "checkbox",
          "id": "override_section_color_scheme",
          "label": "t:common.settings.override_section_color_scheme.label"
        &#125;,
        &#123;
          "type": "color_scheme",
          "id": "color_scheme",
