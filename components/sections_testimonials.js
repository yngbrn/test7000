export default function sections_testimonials() {
  const html = `
    ...
    >
      <div class="splide__track">
        <ul class="splide__list  w-full mt-5mt-10">
            ...
            <li
              class="splide__slide w-4/5 pt-card-shadowpb-card-shadow"
              
            >
              <div class="text-scheme-card-text card">
                <div class="bg-scheme-card card__surface p-5 h-full text-center">
                  
                    
                    <div
                      class="mx-auto mb-5 pt-media-shadowpb-media-shadow"
                      style="max-width: "
                    >
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      ...
      "default": false,
      "info": "t:sections.testimonials.settings.disable_media_style.info"
    &#125;,
    &#123;
      "type": "select",
      "id": "crop",
    ...
    &#123;
      ...
      "step": 5,
      "unit": "%",
      "label": "t:sections.testimonials.settings.desktop_slide_width.label",
      "default": 20
    &#125;,
    &#123;
      "type": "select",
      "id": "autoscroll_mode",
      "label": "t:common.settings.autoscroll_mode.label",
      "options": [
        &#123;
          "value": "1",
        ...
        &#123;
          "value": "0",
          "label": "t:common.options.disabled.label"
        &#125;
      ],
      "default": "1"
    &#125;,
