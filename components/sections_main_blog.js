export default function sections_main_blog() {
  const html = `
              ...
              <ul class="-mx-2.5 -mt-2.5 flex flex-wrap justify-center lg:justify-start">
                <li class="mt-2.5 inline-block px-1.5">
                  <a
                    ...
                    class="btn text-sm after:hidden lg:text-base bg-scheme-secondary-background text-scheme-text bg-scheme-text text-scheme-text-contrast"
                    href=""
                  >
        ...
        <ul class="grid grid-cols-1 gap-10 lg:grid-cols-12">
            ...
            >
              <div class="relative card__surface p-5 text-center">
                ...
                <h2 class="font-heading heading-secondary">
                  <a href="">
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      "type": "checkbox",
      "id": "show_blog_title",
      "label": "t:sections.blog_posts.settings.show_blog_title.label",
      "default": true
    &#125;,
    &#123;
      "type": "checkbox",
