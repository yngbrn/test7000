export default function sections_feature_text_with_offset_images() {
  const html = `
    ...
    <div class="relative z-10 mx-auto">
      <div class="z-10 grid auto-rows-auto grid-cols-1 place-items-center">
        <div class="z-20 col-start-1 col-end-1 row-start-1 row-end-1">
          <div class=" px-section text-center">
            
              <h2 class="feature-text inline-heading-rte font-heading heading-style break-words  heading-effects ">
              ...
              <div class="mx-auto mt-5 flex place-content-center">
...
&#123;
  "name": "t:sections.feature_text_with_offset_images.short_name",
  "settings": [
    &#123;
      "type": "header",
    ...
    &#123;
      ...
      "default": "Feature text with offset images"
    &#125;,
    &#123;
      "type": "range",
    ...
    &#123;
      ...
      "default": false,
      "info": "t:common.settings.apply_effects.info_no_font_selection"
    &#125;,
    &#123;
      "type": "select",
      "id": "max_width_heading",
      "label": "t:sections.feature_text_with_offset_images.settings.max_width_heading.label",
      "options": [
        &#123;
          "value": "",
    ...
    &#123;
      "type": "header",
      "content": "t:sections.feature_text_with_offset_images.settings.image_layout_mobile.label"
    &#125;,
    &#123;
      "type": "range",
      "id": "image_width_mobile",
      "label": "t:sections.feature_text_with_offset_images.settings.image_layout_width.label",
      "min": 30,
      "max": 50,
      "step": 1,
      "unit": "%",
    ...
    &#123;
      ...
      "label": "t:sections.feature_text_with_offset_images.settings.image_layout_gap.label",
      "min": 0,
      "max": 30,
      "step": 1,
      "unit": "%",
    ...
    &#123;
      "type": "range",
      "id": "layout_vertical_spacing_mobile",
      "label": "t:sections.feature_text_with_offset_images.settings.image_layout_vertical_spacing.label",
      "min": 0,
      "max": 20,
      "step": 1,
      "unit": "%",
    ...
    &#123;
      "type": "header",
      "content": "t:sections.feature_text_with_offset_images.settings.image_layout_desktop.label"
    &#125;,
    &#123;
      "type": "range",
    ...
    &#123;
      "type": "range",
      "id": "layout_vertical_spacing_desktop",
      "label": "t:sections.feature_text_with_offset_images.settings.image_layout_vertical_spacing.label",
      "min": 0,
      "max": 10,
      "step": 1,
  ...
  "blocks": [
    ...
    &#123;
      "type": "image",
      "name": "t:common.settings.image.label",
      "limit": 2,
      "settings": [
        &#123;
          "type": "image_picker",
  ...
  "presets": [
    &#123;
      "name": "t:sections.feature_text_with_offset_images.name",
      "settings": &#123;
        "mobile_text_scale": 3,
        "desktop_text_scale": 7
      &#125;,
      "blocks": [
        &#123;
          "type": "image",
