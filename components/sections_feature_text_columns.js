export default function sections_feature_text_columns() {
  const html = `

<section
  class="relative grid bg-scheme-background text-scheme-text bg-scheme-gradient relative overflow-hidden"
  data-color-scheme=""
>
  <div class="section-content relative z-10 mx-auto max-w-site px-section py-section-vertical-spacing">
    ...
    <ul class="section-content-top-margin grid grid-cols-1 gap-10 lg:grid-cols-12">
        ...
        >
          <div class="card__surface p-5 h-full text-center">
            
              < class="inline-heading-rte font-heading  break-words">
...
&#123;
  "name": "t:sections.feature_text_columns.name",
  "settings": [
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
      "label": "t:sections.feature_text_columns.settings.display_on_card.label"
    &#125;,
    &#123;
    ...
    &#123;
      "type": "select",
      "id": "heading_size",
      "label": "t:sections.feature_text_columns.settings.heading_size.label",
      "options": [
        &#123;
    ...
    &#123;
      "type": "select",
      "id": "subheading_font",
      "label": "t:sections.feature_text_columns.settings.subheading_font.label",
      "options": [
        &#123;
          "value": "heading",
  ...
  "blocks": [
    &#123;
      "type": "column",
      "name": "t:sections.feature_text_columns.blocks.column.name",
      "limit": 4,
      "settings": [
        &#123;
          "type": "inline_richtext",
        ...
        &#123;
          "type": "inline_richtext",
          "id": "subheading",
          "label": "t:sections.feature_text_columns.blocks.column.settings.subheading.label",
