export default function sections_main_list_collections() {
  const html = `


  <section
    class="relative overflow-hidden bg-scheme-background py-section-vertical-spacing text-scheme-text bg-scheme-gradient"
    data-color-scheme=""
  >
    <div class="space-y-double-section-vertical-spacing">
        ...
        <div class="section-content relative z-10 px-section max-w-site mx-auto">
          <h2 class="font-heading heading-standard  heading-style break-words text-center ">
            
          </h2>
          
            <div class="rte mx-auto mt-5 max-w-lg text-center">
  ...
  "settings": [
    &#123;
      ...
      "options": [
        ...
        &#123;
          "value": "carousel",
          "label": "t:common.options.carousel.label"
        &#125;
      ]
    &#125;,
    &#123;
    ...
    &#123;
      ...
      "label": "t:sections.collection_list.settings.show_collection_description.label",
      "default": true
    &#125;,
    &#123;
      "type": "checkbox",
