export default function sections_menu() {
  const html = `
...
>
  ...
  >
      ...
      <h2
        class="font-heading  heading-style mx-auto text-center"
        id="-tablist_menu"
      >
      ...
      <div
        class="section-content-top-margin flex flex-wrap justify-center gap-4 text-center text-scheme-text"
        role="tablist"
        aria-labelledby="-tablist_menu"
      >
            ...
            <button
              @click="tab = ''"
              :class="&#123; 'active bg-scheme-text text-scheme-text-contrast': tab === '' &#125;"
              class="btn relative bg-scheme-secondary-background text-sm text-scheme-text after:hidden lg:text-base"
              id="-"
              type="button"
              role="tab"
    ...
    >
      <div class="max-w-3xlmax-w-2xl section-content-top-margin mx-auto">
                        ...
                        >
                          <div class="col-span-2 row-span-2 grid gap-x-4 ">
                              ...
                              <div class="col-span-1 col-start-1">
                                <h4 class="inline-heading-rte font-bold ">
                              ...
                              <div class="col-start-1 row-start-1 col-span-1row-start-2 col-span-2 mt-2 ">
                                <p class="text-sm">
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      "type": "checkbox",
      "id": "enable_tabs",
      "label": "t:sections.menu.settings.enable_tabs.label",
      "info": "t:sections.menu.settings.enable_tabs.info",
      "default": true
    &#125;,
    &#123;
      "type": "text",
    ...
    &#123;
      "type": "text",
      "id": "tab_3",
      "label": "t:sections.menu.settings.tab_title_3.label"
    &#125;,
    &#123;
      "type": "header",
    ...
    &#123;
      "type": "select",
      "id": "menu_heading_style",
      "label": "t:sections.menu.settings.menu_heading_style.label",
      "options": [
        &#123;
    ...
    &#123;
      "type": "select",
      "id": "title_price_color",
      "label": "t:sections.menu.settings.title_price_text_color.label",
      "options": [
        &#123;
          "value": "text-scheme-text",
          "label": "t:common.options.text.label"
        &#125;,
        &#123;
          "value": "text-scheme-accent-1",
          "label": "t:common.options.accent_1.label"
        &#125;,
        &#123;
          "value": "text-scheme-accent-2",
          "label": "t:common.options.accent_2.label"
        &#125;,
        &#123;
          "value": "text-scheme-card",
          "label": "t:common.options.card.label"
        &#125;
      ],
      "default": "text-scheme-accent-1"
    &#125;,
    &#123;
      "type": "checkbox",
      "id": "show_menu_title_border",
      "label": "t:sections.menu.settings.show_menu_title_border.label",
      "info": "t:sections.menu.settings.show_menu_title_border.info",
      "default": true
    &#125;,
    &#123;
      "type": "header",
      ...
      "settings": [
        ...
        &#123;
          ...
          "options": [
            ...
            &#123;
              "value": "tab_3",
              "label": "t:sections.menu.settings.tab_3.label"
            &#125;
          ],
          "default": "tab_1"
        &#125;,
        ...
        &#123;
          "type": "text",
          "id": "price_1",
          "label": "t:sections.menu.settings.price.label",
          "default": "$10"
        &#125;,
        &#123;
          "type": "text",
          "id": "description_1",
          "label": "t:sections.menu.settings.description.label",
          "default": "Menu item description"
        &#125;,
        &#123;
          "type": "header",
        ...
        &#123;
          "type": "header",
          "content": "t:common.options.item_7.label"
        &#125;,
        &#123;
          "type": "text",
          "id": "title_7",
        ...
        &#123;
          "type": "header",
          "content": "t:common.options.item_8.label"
        &#125;,
        &#123;
          "type": "text",
          "id": "title_8",
        ...
        &#123;
          "type": "header",
          "content": "t:common.options.item_9.label"
        &#125;,
        &#123;
          "type": "text",
          "id": "title_9",
        ...
        &#123;
          "type": "header",
          "content": "t:common.options.item_10.label"
        &#125;,
        &#123;
          "type": "text",
          "id": "title_10",
