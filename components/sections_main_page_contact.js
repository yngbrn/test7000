export default function sections_main_page_contact() {
  const html = `<section
  class="relative overflow-hidden bg-scheme-background text-scheme-text bg-scheme-gradient "
  data-color-scheme=""
>
  <div class="section-content px-section py-section-vertical-spacing max-w-3xlmax-w-2xl mx-auto">
    <div class="text-scheme-text card">
      <div class="card__surface p-5 lg:p-10">
        <h1 class="font-heading heading-feature heading-style break-words text-center ">
        ...
        <div class="mt-5">
              ...
              <div class="lg:grid lg:grid-cols-2 lg:gap-4">
                <div>
                  <label class="" for="ContactFormName">
                ...
                <div>
                  <label class="" for="ContactFormEmail">
              ...
              <label class="" for="ContactFormPhone">
              ...
              <label class="" for="ContactFormMessage">
              ...
              <div class="push-btn mt-5 w-full">
                <input
                  type="submit"
...
&#123;
  "name": "t:sections.pages__contact.name",
  "settings": [
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
