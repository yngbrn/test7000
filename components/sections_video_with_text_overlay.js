export default function sections_video_with_text_overlay() {
  const html = `<section
  class="grid bg-scheme-background text-scheme-text bg-scheme-gradient full-bleed-section"
  data-color-scheme=""
>
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      ...
      "id": "title",
      "label": "t:sections.video_with_text_overlay.settings.title.label",
