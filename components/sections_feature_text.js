export default function sections_feature_text() {
  const html = `<section
  ...
  <div class="section-content px-section py-section-vertical-spacing">
    <div class="mx-auto max-w-site  card">
      <div class="card__surface p-5 lg:p-10 relative z-shape-divider mx-auto text-center">
        <div class="feature-text inline-heading-rte font-heading break-words heading-effects mx-auto ">
...
&#123;
  "name": "t:sections.feature_text.name",
  "settings": [
    &#123;
      "id": "rich_text",
      "type": "inline_richtext",
      "label": "t:sections.feature_text.settings.rich_text.label",
    &#125;,
    &#123;
      "type": "range",
    ...
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
      "label": "t:sections.feature_text.settings.display_on_card.label",
      "default": false
    &#125;,
    &#123;
      "type": "checkbox",
    ...
    &#123;
      ...
      "label": "t:sections.feature_text.settings.content_width_desktop.label",
      "default": "lg:w-full",
      "options": [
        &#123;
          "value": "lg:w-1/3",
