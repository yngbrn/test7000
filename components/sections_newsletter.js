export default function sections_newsletter() {
  const html = `<section
              ...
              <div class="items-center justify-center lg:flex">
                ...
                <div class="w-full flex-grow lg:mr-2">
                  <input
                    ...
                    type="email"
                    name="contact[email]"
                    class="input-group-field w-full placeholder:text-scheme-text  border-scheme-errorborder-scheme-text"
                    value=""
                    autocorrect="off"
                    autocapitalize="off"
                    autocomplete="email"
...
&#123;
  ...
  "settings": [
    ...
    &#123;
      "type": "richtext",
      "id": "richtext",
      "label": "t:sections.newsletter.settings.richtext.label",
