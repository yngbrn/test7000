export default function sections_main_404() {
  const html = `<section
  class="relative overflow-hidden bg-scheme-background text-scheme-text bg-scheme-gradient "
  data-color-scheme=""
>
  <div class="section-content px-section py-section-vertical-spacing text-center">
    <h1 class="font-heading heading-feature heading-style  mb-2.5">
      
    </h1>
    <p></p>
    <a class="push-btn mt-10 inline-block" href="">
