export default function sections_featured_testimonials() {
  const html = `
...
>
  <div class="section-content py-section-vertical-spacing">
      ...
      <h2 class="inline-heading-rte font-heading heading-standard  heading-style break-words text-center  px-section">
    ...
    >
      <div class="splide__track">
        <ul class="splide__list  w-full mt-5mt-10">
          
            
            <li
              class="splide__slide mx-auto w-full  pt-card-shadowpb-card-shadow"
                ...
                <div class="text-scheme-card-text card">
                  <div class="bg-scheme-card card__surface p-5 h-full break-words text-center">
                    <blockquote class="text-center">
                        ...
                        <span class="mb-5 block text-center tracking-rating">
                      ...
                      <div class="inline-heading-rteinline-rte  ">
                        ...
                        <div class="mt-10 space-y-5">
                            ...
                            <div
                              class="mx-auto pt-media-shadowpb-media-shadow"
                              style="max-width: px"
                            >
...
&#123;
  "name": "t:sections.feature_testimonials.name",
  "settings": [
    &#123;
      "type": "checkbox",
      "id": "display_on_card",
    ...
    &#123;
      "type": "header",
      "content": "t:sections.testimonials.name"
    &#125;,
    &#123;
      "type": "select",
      "id": "font",
    ...
    &#123;
      "type": "select",
      "id": "source_font",
      "label": "t:sections.feature_testimonials.settings.source_font.label",
      "options": [
        &#123;
      ...
      "settings": [
        ...
        &#123;
          ...
          "options": [
            &#123;
              "value": "none",
              "label": "t:sections.testimonials.blocks.testimonial.settings.rating.options.no_rating.label"
            &#125;,
            &#123;
              "value": "5_stars",
              "label": "t:sections.testimonials.blocks.testimonial.settings.rating.options.5_stars.label"
            &#125;,
            &#123;
              "value": "4_stars",
              "label": "t:sections.testimonials.blocks.testimonial.settings.rating.options.4_stars.label"
            &#125;,
            &#123;
              "value": "3_stars",
              "label": "t:sections.testimonials.blocks.testimonial.settings.rating.options.3_stars.label"
            &#125;,
            &#123;
              "value": "2_stars",
              "label": "t:sections.testimonials.blocks.testimonial.settings.rating.options.2_stars.label"
            &#125;,
            &#123;
              "value": "1_stars",
              "label": "t:sections.testimonials.blocks.testimonial.settings.rating.options.1_star.label"
            &#125;
          ],
          "default": "5_stars"
        &#125;,
        ...
        &#123;
          "type": "text",
          "id": "source",
          "label": "t:sections.testimonials.blocks.testimonial.settings.source.label",
          "default": "Source"
        &#125;
      ]
    &#125;,
